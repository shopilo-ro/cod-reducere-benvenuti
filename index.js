#!/usr/bin/env node
/**
 * Fetch coduri reducere Benvenuti de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/benvenuti.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/benvenuti.ro";
const STORE_NAME  = "Benvenuti";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-benvenuti)" }
  });
